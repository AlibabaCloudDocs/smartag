...
1.  After receiving the SAG device, follow [SAG-1000 user manual](../intl.en-US/Product Introduction/Smart Access Gateway device/SAG-1000.md#) to check if all the accessories are provided, and then power on the SAG device.
...
4.  Open your browser and enter the web configuration address of the SAG device.
    ...
    The default IP address is https: // 192.168.0.1. For more information, see [Log on to the web configuration page](../intl.en-US/SAG-1000 Configuration Guide/Web configuration/Step 2: Set the password when you log on for the first time.md#).
...
5.  Configure the service IP address and the management port.
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41718/156074312841206_en-US.png)
...
6.  Configure the ports used to communicate with the switches:
    ...
    -   **Port**: Click the **Edit** option in the **Configuration Information** area, enter the IP addresses of the ports used for communication and select whether to enable Open Shortest Path First \(OSPF\).
        ...
        ![](images/41252_en-US.png)

7.  Configure OSPF.

    In this tutorial, MD5 authentication is selected, and the service IP address used by the RouterID is 192.168.101.1.

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41718/156074312941207_en-US.png)
