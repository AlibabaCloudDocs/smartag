...
-   您已经在上海地域创建了专有网络（VPC），详情请参见[创建专有网络](/cn.zh-CN/专有网络和交换机/管理专有网络/创建专有网络.md)。
...
1.  开通OSS云服务。详情请参见[开通OSS服务](/cn.zh-CN/快速入门/开通OSS服务.md)。
...
4.  在设置云服务页面，配置以下信息。
    ...
    -   **云服务IP或地址段**：输入属于100.64.0.0/10 子网段的OSS云服务IP地址或地址段。本示例输入100.118.102.0/24。
        ...
        -   100.98.169.0/24
        -   100.118.102.0/24
        OSS云服务各地域网段详情，请参见[VPC网络下Region和Endpoint对照表](/cn.zh-CN/开发指南/访问域名（Endpoint）/访问域名和数据中心.md)。
