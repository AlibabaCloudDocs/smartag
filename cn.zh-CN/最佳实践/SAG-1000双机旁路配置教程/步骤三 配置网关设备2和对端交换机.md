...
4.  配置业务IP和管理口。
    ...
    **说明：** 确保指定的业务IP可访问Internet。旁挂组网模式需要在公网出口开启NAT映射。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23999/154898797113925_zh-CN.png)
...
5.  配置和交换机通信的端口：
    ...
    -   **端口**：单击**配置信息**区域的**编辑**选项，然后输入用来互通的端口IP并选择是否开启OSPF路由。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23999/154898797113926_zh-CN.png)

6.  配置OSPF。

    本操作选择MD5认证，RouterID使用业务IP192.168.101.2。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23999/154898797113927_zh-CN.png)
