...
-   Windows客户端：为Windows客户端配置静态IP。
    ...
    4.  双击**Internet 协议版本4（TCP/IPv4）**选项。
        ...
        ![TCP/IPv4](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40489/156554042621208_zh-CN.png)

    5.  选择**自动获得IP地址**和**自动获得DNS服务器地址**。

        ![DNS](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40489/156554042621209_zh-CN.png)
...
-   Mac客户端：为Mac客户端配置静态IP。
    ...
    4.  在**配置IPv4**选项中，选择**使用DHCP**。
        ...
        ![DHCP](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40489/156554042721226_zh-CN.png)
...
2.  设置Web登录密码。 
    ...
    ![Web密码](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40490/156554042721180_zh-CN.png)
...
4.  选择是否开启SNAT转发，开启SNAT转发后，由本地局域网向广域网发送的数据包默认经过NAT转发。 
    ...
    -   PPPoE：如果通过拨号方式接入互联网，选择该方式。然后输入运营商提供的PPPoE的账号和密码。
        ...
        ![wan口管理](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40491/156554042741150_zh-CN.png)
...
3.  在LAN口管理页面，配置LAN口信息。 
 ...
 |
        ...
        ![无线设置](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40492/156554042841292_zh-CN.png)
    ...
    -   有线模式
        ...
        -   动态IP：
            ...
            ![线下接入](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/15409/15655404286822_zh-CN.png)

        -   静态IP:

            如果线下客户端的IP已经通过线下交换机配置好了，如下图所示，请选择静态IP方式。

            ![静态IP](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40492/156554042821798_zh-CN.png)
